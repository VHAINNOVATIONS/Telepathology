 ...
 *
 */
public class ValidateImagingRouterFacadeTest
{
	@Test
	public void testGeneratedFacade()
	{
		try
		{
			GeneratedCodeValidationUtility.validateImplementation(
				gov.va.med.imaging.router.facade.ImagingRouter.class, 
				gov.va.med.imaging.router.facade.ImagingRouterImpl.class
			);
		}
