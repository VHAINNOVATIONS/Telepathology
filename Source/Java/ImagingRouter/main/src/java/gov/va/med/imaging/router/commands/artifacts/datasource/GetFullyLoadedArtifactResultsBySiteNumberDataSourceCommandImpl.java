 ...
 *
 */
public class GetFullyLoadedArtifactResultsBySiteNumberDataSourceCommandImpl
extends AbstractArtifactResultsBySiteNumberDataSourceCommandImpl
{
	private static final long serialVersionUID = -5950455561504719424L;
	
	private final static StudyLoadLevel studyLoadLevel = StudyLoadLevel.FULL;
	
	public GetFullyLoadedArtifactResultsBySiteNumberDataSourceCommandImpl(
