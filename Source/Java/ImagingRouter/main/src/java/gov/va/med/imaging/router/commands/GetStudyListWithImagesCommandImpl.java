...
/**
 * Command to get the list of studies for a patient including the images but NOT including the reports.
 * 
 * @author vhaiswwerfej
 *
 */
public class GetStudyListWithImagesCommandImpl 
extends AbstractStudyCommandImpl<List<Study>>
{
	private static final long serialVersionUID = 2768444646662907999L;
	...
	public GetStudyListWithImagesCommandImpl(
	...
	throws MethodException, ConnectionException 
	{
		...
		List<Study> studies = this.getPatientStudyList(getRoutingToken(), getPatientIdentifier(), filter, studyLoadLevel);
		return studies;
	}
