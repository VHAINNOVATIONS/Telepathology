 ...
 *
 */
public class GetInstanceTextFileByImageUrnFromDataSourceCommandImpl 
extends AbstractDataSourceCommandImpl<DataSourceInputStream, ImageDataSourceSpi>
{
	private static final long serialVersionUID = -3401309809311584341L;
	
	private final ImageURN imageUrn;
	private static final String SPI_METHOD_NAME = "getImageTXTFile";
	
	public GetInstanceTextFileByImageUrnFromDataSourceCommandImpl(ImageURN imageUrn)
	{
