 ...
 *
 */
public class GetStudyWithImagesArtifactResultsBySiteNumberDataSourceCommandImpl
extends AbstractArtifactResultsBySiteNumberDataSourceCommandImpl
{
	private static final long serialVersionUID = -224617235115963810L;
	
	private final static StudyLoadLevel studyLoadLevel = StudyLoadLevel.STUDY_AND_IMAGES;
	
	public GetStudyWithImagesArtifactResultsBySiteNumberDataSourceCommandImpl(
