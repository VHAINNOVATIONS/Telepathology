 ...
 *
 */
public class GetExamRequisitionReportFromDataSourceCommandImpl 
extends AbstractDataSourceCommandImpl<String, VistaRadDataSourceSpi> 
{
	private static final long serialVersionUID = 1L;
	
	private final StudyURN studyUrn;
	private static final String SPI_METHOD_NAME = "getExamRequisitionReport";
	
	public GetExamRequisitionReportFromDataSourceCommandImpl(StudyURN studyUrn)
	{
	...
	{
		String report = spi.getExamRequisitionReport(getStudyUrn());		
		getLogger().info("Got requistion report length of " + ((report == null || report.length() == 0) ? "0" : report.length()) + " bytes.");
		return report;
	}
