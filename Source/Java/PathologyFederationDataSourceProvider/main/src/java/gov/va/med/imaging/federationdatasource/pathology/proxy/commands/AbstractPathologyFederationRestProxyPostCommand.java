...
import gov.va.med.imaging.federation.rest.proxy.commands.AbstractFederationRestProxyPostCommand;
 ...
 *
 */
public abstract class AbstractPathologyFederationRestProxyPostCommand<R, T extends Object>
extends AbstractFederationRestProxyPostCommand<R, T>
{
	 ...
	 */
	public AbstractPathologyFederationRestProxyPostCommand(String methodName,
