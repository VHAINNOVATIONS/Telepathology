 ...
 */
@Provider
public class RestPatientNotFoundExceptionMapper
extends AbstractRestExceptionMapper<PatientNotFoundException>
{

	@Override
	public Throwable getRelevantException(PatientNotFoundException exception)
	{
		return exception;
	}
