 ...
 *
 */
public class TransactionLogEntryVixSoftwareVersion
extends TransactionLogEntryElement
{
	...
	{
		return getTransactionLogEntry().getVixSoftwareVersion() == null ?
				"" :
				getTransactionLogEntry().getVixSoftwareVersion();
	}
