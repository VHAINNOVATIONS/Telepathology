 ...
 */
@Provider
public class RestSecurityCredentialsExpiredExceptionMapper 
extends AbstractRestExceptionMapper<SecurityCredentialsExpiredException> 
{

	@Override
	public Throwable getRelevantException(
			SecurityCredentialsExpiredException exception)
	{
		return exception;
	}
