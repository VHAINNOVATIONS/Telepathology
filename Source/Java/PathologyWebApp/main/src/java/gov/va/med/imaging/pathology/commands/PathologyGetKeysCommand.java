 ...
 *
 */
public class PathologyGetKeysCommand
extends AbstractPathologyCommand<List<String>, RestStringArrayType>
{
	 ...
	 * @param methodName
	 */
	public PathologyGetKeysCommand(String siteId)
	{
		super("getKeys");
		this.siteId = siteId;
	}
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			return getRouter().getPathologyKeys(routingToken);
		}
