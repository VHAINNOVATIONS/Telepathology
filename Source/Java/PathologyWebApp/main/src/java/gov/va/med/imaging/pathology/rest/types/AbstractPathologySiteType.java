 ...
 */
@XmlRootElement
public abstract class AbstractPathologySiteType
{
	...
	public AbstractPathologySiteType()
	{
		super();
	}

	public AbstractPathologySiteType(String siteId, String siteName, String siteAbbr,
			boolean active)
	{
		super();
		this.siteId = siteId;
