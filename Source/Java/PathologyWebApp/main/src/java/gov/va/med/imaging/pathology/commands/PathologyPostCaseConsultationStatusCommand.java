 ...
 *
 */
public class PathologyPostCaseConsultationStatusCommand
extends AbstractPathologyCommand<Boolean, RestBooleanReturnType>
{
	private final String caseConsultationId;
	private final PathologyCaseConsultationUpdateStatusType caseConsultationUpdateStatus;

	/**
	 * @param methodName
	 */
	public PathologyPostCaseConsultationStatusCommand(String caseConsultationId, 
			PathologyCaseConsultationUpdateStatusType caseConsultationUpdateStatus)
	{
		super("updateCaseConsultationStatus");
	...
	public PathologyCaseConsultationUpdateStatusType getCaseConsultationUpdateStatus()
	{
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			PathologyCaseConsultationUpdateStatus caseConsultationUpdateStatus = 
				PathologyRestTranslator.translate(getCaseConsultationUpdateStatus()); 
