 ...
 *
 */
public class PathologyGetSitesCommand
extends AbstractPathologyCommand<List<PathologySite>, PathologySitesType>
{
	private final String siteId;
	
	public PathologyGetSitesCommand(String siteId)
	{
		super("getSites");
		this.siteId = siteId;
	}
	 ...
	 */
	@Override
	protected PathologySitesType translateRouterResult(
			List<PathologySite> routerResult) 
	throws TranslationException, MethodException
	{
		return PathologyRestTranslator.translateSites(routerResult);
	}
	 ...
	 */
	@Override
	protected Class<PathologySitesType> getResultClass()
	{
		return PathologySitesType.class;
	}
	 ...
	 */
	@Override
	public Integer getEntriesReturned(PathologySitesType translatedResult)
	{
		return translatedResult == null ? 0 : translatedResult.getSite().length;
	}
