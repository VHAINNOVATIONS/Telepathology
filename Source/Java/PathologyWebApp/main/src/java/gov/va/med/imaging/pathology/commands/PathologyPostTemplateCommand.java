 ...
 *
 */
public class PathologyPostTemplateCommand
extends AbstractPathologyCommand<Boolean, RestBooleanReturnType>
{
	
	private final String siteId;
	private final String apSection;
	private final PathologyTemplateInputType templateInput;
	
	public PathologyPostTemplateCommand(String siteId,
			String apSection, PathologyTemplateInputType templateInput)
	{
		super("postTemplate");
		this.siteId = siteId;
	...
	public PathologyTemplateInputType getTemplateInput()
	{
	...
	throws MethodException, ConnectionException
	{
		try
		{
			if(getTemplateInput() == null || getTemplateInput().getXmlTemplate() == null)
				throw new MethodException("Null XML template input.");
			RoutingToken routingToken =
				RoutingTokenHelper.createSiteAppropriateRoutingToken(getSiteId());
			getRouter().saveSiteTemplate(routingToken, getApSection(), getTemplateInput().getXmlTemplate());
			return true;
		}
