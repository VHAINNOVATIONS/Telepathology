 ...
 *
 */
public class PathologyGetCaseSnomedCodesCommand
extends AbstractPathologyCommand<List<PathologySnomedCode>, PathologySnomedCodesType>
{
	 ...
	 * @param methodName
	 */
	public PathologyGetCaseSnomedCodesCommand(String caseId)
	{
		super("getCaseSnomedCodes");
		this.caseId = caseId;
	}
	 ...
	 */
	@Override
	protected PathologySnomedCodesType translateRouterResult(
			List<PathologySnomedCode> routerResult)
	throws TranslationException, MethodException
	{
		return PathologyRestTranslator.translateSnomedCodes(routerResult);
	}
	 ...
	 */
	@Override
	protected Class<PathologySnomedCodesType> getResultClass()
	{
		return PathologySnomedCodesType.class;
	}
	 ...
	 */
	@Override
	public Integer getEntriesReturned(PathologySnomedCodesType translatedResult)
	{
		return translatedResult == null ? 0 : translatedResult.getCode().length;
	}
