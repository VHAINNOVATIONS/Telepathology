 ...
 *
 */
public class PathologyPostAcquisitionSiteCommand
extends AbstractPathologyCommand<Boolean, RestBooleanReturnType>
{
	private final String siteId;
	private final PathologyAcquisitionSiteType acquisitionSite;
	private final boolean delete;
	
	public PathologyPostAcquisitionSiteCommand(String siteId, PathologyAcquisitionSiteType acquisitionSite,
			boolean delete)
	{
	...
	public PathologyAcquisitionSiteType getAcquisitionSite()
	{
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			PathologyAcquisitionSite acquisitionSite = PathologyRestTranslator.translate(getAcquisitionSite());
	...
	{
		return "to site '" + getSiteId() + "', updating acquisition site '" + getAcquisitionSite().getSiteId() + ", deleting [" + isDelete() + "].";
	}
