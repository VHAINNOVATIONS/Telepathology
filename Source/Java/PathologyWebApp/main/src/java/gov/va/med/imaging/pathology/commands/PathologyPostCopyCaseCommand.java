 ...
 *
 */
public class PathologyPostCopyCaseCommand
extends AbstractPathologyCommand<PathologyCaseURN, PathologyCopyCaseResultType>
{
	 ...
	 * @param methodName
	 */
	public PathologyPostCopyCaseCommand(String siteId, String caseId)
	{
		super("copyCase");
		this.siteId = siteId;
		this.caseId = caseId;
	 ...
	 */
	@Override
	protected PathologyCopyCaseResultType translateRouterResult(PathologyCaseURN routerResult)
	 ...
	 */
	@Override
	protected Class<PathologyCopyCaseResultType> getResultClass()
	{
		return PathologyCopyCaseResultType.class;
	}
	 ...
	 */
	@Override
	public Integer getEntriesReturned(PathologyCopyCaseResultType translatedResult)
	{
		return null;
	}
