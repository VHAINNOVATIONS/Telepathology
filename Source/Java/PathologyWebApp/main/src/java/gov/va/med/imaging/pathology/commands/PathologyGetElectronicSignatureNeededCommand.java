 ...
 *
 */
public class PathologyGetElectronicSignatureNeededCommand
extends AbstractPathologyCommand<PathologyElectronicSignatureNeed, PathologyElectronicSignatureNeedType>
{
	 ...
	 * @param methodName
	 */
	public PathologyGetElectronicSignatureNeededCommand(String siteId, String apSection)
	{
		super("checkElectronicSignatureNeeded");
		this.siteId = siteId;
	...
	{
		return "to site '" + getSiteId() + "' for AP Section '" + getApSection() + "'.";
	}
	 ...
	 */
	@Override
	protected PathologyElectronicSignatureNeedType translateRouterResult(
	 ...
	 */
	@Override
	protected Class<PathologyElectronicSignatureNeedType> getResultClass()
	{
		return PathologyElectronicSignatureNeedType.class;
	}
	...
	public Integer getEntriesReturned(
			PathologyElectronicSignatureNeedType translatedResult)
	{
		return null;
	}
