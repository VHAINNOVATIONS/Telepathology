 ...
 *
 */
public class PathologyLockCaseCommand
extends AbstractPathologyCommand<PathologyCaseUpdateAttributeResult, PathologyCaseUpdateAttributeResultType>
{
	...
	public PathologyLockCaseCommand(String pathologyCaseId, boolean lock)
	{
		super("lockCase");
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			return getRouter().lockPathologyCase(pathologyCaseUrn, isLock());
		}
