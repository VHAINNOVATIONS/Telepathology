 ...
 *
 */
public class PathologyPostLockMinutesCommand
extends AbstractPathologyCommand<Boolean, RestBooleanReturnType>
{
	private final String siteId;
	private final int minutes;
	
	public PathologyPostLockMinutesCommand(String siteId, int minutes)
	{
		super("saveLockMinutes");
		this.siteId = siteId;
	...
	{
		return "for site '" + getSiteId() + "', setting minutes to '" + getMinutes() + "'.";
	}
