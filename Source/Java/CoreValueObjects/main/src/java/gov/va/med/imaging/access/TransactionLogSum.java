 ...
 */
public class TransactionLogSum 
extends TransactionLogStatistics
{
	 ...
	 */
	public TransactionLogSum (ByteTransferPath byteTransferPath)
	{
	...
	/* (non-Javadoc)
	 * @see gov.va.med.imaging.access.TransactionLogStatistics#getDataSourceItemsReceived()
	 */
	@Override
	public Integer getDataSourceItemsReceived() 
	{
		return sumDataSourceItemsReceived;
	}
}
