...
/**
 * SPI to retrieve information about a site, not specific to a user or patient
 * 
 * @author VHAISWWERFEJ
 *
 */
@SPI(description="Interface to get site information.")
public interface SiteDataSourceSpi
