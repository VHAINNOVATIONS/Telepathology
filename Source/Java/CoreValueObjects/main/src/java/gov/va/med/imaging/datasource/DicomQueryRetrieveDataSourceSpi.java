...
public interface DicomQueryRetrieveDataSourceSpi 
extends VersionableDataSourceSpi {

    abstract CFindResults getCFindResults(DicomRequestParameters request)
    throws MethodException, ConnectionException;

    abstract CMoveResults getCMoveResults(DicomRequestParameters request)
    throws MethodException, ConnectionException;
	
	abstract DicomInstanceUpdateInfo getDicomInstanceUpdateInfo(InstanceStorageInfo instance)
	throws MethodException, ConnectionException;
