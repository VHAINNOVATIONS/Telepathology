 ...
 *
 */
@SPI(description="Defines the interface to authenticate a user.")
public interface UserAuthenticationSpi 
extends VersionableDataSourceSpi 
{	
	/**
	 * Authenticate the user based on the credentials in the TransactionContext
