 ...
 *
 */
public class DicomStorageCommitSCPException extends Exception {

    /**
     * 
     */
    public DicomStorageCommitSCPException() {
        super();
    }
     ...
     * @param message
     */
    public DicomStorageCommitSCPException(String message) {
        super(message);
    }
     ...
     * @param cause
     */
    public DicomStorageCommitSCPException(Throwable cause) {
        super(cause);
   }
     ...
     * @param cause
     */
    public DicomStorageCommitSCPException(String message, Throwable cause) {
        super(message, cause);
    }
