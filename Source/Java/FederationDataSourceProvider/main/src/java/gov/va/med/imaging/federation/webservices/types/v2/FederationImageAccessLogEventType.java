...
public class FederationImageAccessLogEventType  implements java.io.Serializable {
    ...
    private gov.va.med.imaging.federation.webservices.types.v2.FederationImageAccessLogEventTypeEventType eventType;
    ...
    public FederationImageAccessLogEventType(
           ...
           gov.va.med.imaging.federation.webservices.types.v2.FederationImageAccessLogEventTypeEventType eventType) {
     ...
     * @return eventType
     */
    public gov.va.med.imaging.federation.webservices.types.v2.FederationImageAccessLogEventTypeEventType getEventType() {
        return eventType;
    }
     ...
     * @param eventType
     */
    public void setEventType(gov.va.med.imaging.federation.webservices.types.v2.FederationImageAccessLogEventTypeEventType eventType) {
        this.eventType = eventType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:v2.types.webservices.federation.imaging.med.va.gov", "FederationImageAccessLogEventType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:v2.types.webservices.federation.imaging.med.va.gov", ">FederationImageAccessLogEventType>eventType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
