...
import gov.va.med.imaging.federation.proxy.FederationVistaRadImageProxyV3;
 ...
 *
 */
public class FederationVistaRadImageDataSourceServiceV3 
...
implements VistaRadImageDataSourceSpi
{
	...
	private FederationVistaRadImageProxyV3 proxy = null;
	 ...
	 */
	public FederationVistaRadImageDataSourceServiceV3(ResolvedArtifactSource resolvedArtifactSource, String protocol)
		throws UnsupportedOperationException
	{
		super(resolvedArtifactSource, protocol);
	}
	
	private FederationVistaRadImageProxyV3 getProxy()
	throws ConnectionException
	{
		if(proxy == null)
		{
			...
			proxy = new FederationVistaRadImageProxyV3(proxyServices, FederationDataSourceProvider.getFederationConfiguration());
		}
		return proxy;
	}	
