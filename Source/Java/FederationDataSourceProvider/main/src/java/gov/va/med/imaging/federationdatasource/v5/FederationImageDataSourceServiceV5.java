...
import gov.va.med.imaging.federation.proxy.v5.FederationRestImageProxyV5;
import gov.va.med.imaging.federationdatasource.FederationImageDataSourceServiceV4;
 ...
 *
 */
public class FederationImageDataSourceServiceV5 
extends FederationImageDataSourceServiceV4
{
	private final static String DATASOURCE_VERSION = "5";
	
	private FederationRestImageProxyV5 proxy = null;
	 ...
	 */
	public FederationImageDataSourceServiceV5(ResolvedArtifactSource resolvedArtifactSource, String protocol)
		throws UnsupportedOperationException
	{
	...
	private FederationRestImageProxyV5 getProxy()
	throws ConnectionException
	{
		if(proxy == null)
		{
			...
			proxy = new FederationRestImageProxyV5(proxyServices, getFederationConfiguration());
		}
		return proxy;
	}
}
