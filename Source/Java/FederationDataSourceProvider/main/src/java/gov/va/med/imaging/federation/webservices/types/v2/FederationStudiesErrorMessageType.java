...
public class FederationStudiesErrorMessageType  implements java.io.Serializable {
    ...
    private gov.va.med.imaging.federation.webservices.types.v2.FederationStudiesErrorType studiesError;
    ...
    public FederationStudiesErrorMessageType(
           ...
           gov.va.med.imaging.federation.webservices.types.v2.FederationStudiesErrorType studiesError) {
     ...
     * @return studiesError
     */
    public gov.va.med.imaging.federation.webservices.types.v2.FederationStudiesErrorType getStudiesError() {
        return studiesError;
    }
     ...
     * @param studiesError
     */
    public void setStudiesError(gov.va.med.imaging.federation.webservices.types.v2.FederationStudiesErrorType studiesError) {
        this.studiesError = studiesError;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:v2.types.webservices.federation.imaging.med.va.gov", "FederationStudiesErrorMessageType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:v2.types.webservices.federation.imaging.med.va.gov", "FederationStudiesErrorType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
