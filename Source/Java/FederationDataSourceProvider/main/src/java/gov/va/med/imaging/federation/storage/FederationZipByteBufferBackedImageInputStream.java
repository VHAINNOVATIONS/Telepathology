...
/**
 * Extends ByteBufferBackedImageInputStream and returns false for isCloseInputStreamWhenReadComplete() so the input
 ...
 *
 */
public class FederationZipByteBufferBackedImageInputStream 
extends ByteBufferBackedImageInputStream 
{
	public FederationZipByteBufferBackedImageInputStream(InputStream inputStream, int size, 
			boolean readIntoBuffer, String providedChecksum)
	throws IOException
	{
