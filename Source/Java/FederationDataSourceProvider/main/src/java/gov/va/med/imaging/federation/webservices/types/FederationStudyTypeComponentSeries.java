...
public class FederationStudyTypeComponentSeries  implements java.io.Serializable {
    private gov.va.med.imaging.federation.webservices.types.FederationSeriesType[] series;

    public FederationStudyTypeComponentSeries() {
    }

    public FederationStudyTypeComponentSeries(
           gov.va.med.imaging.federation.webservices.types.FederationSeriesType[] series) {
           this.series = series;
    }
     ...
     * @return series
     */
    public gov.va.med.imaging.federation.webservices.types.FederationSeriesType[] getSeries() {
        return series;
    }
     ...
     * @param series
     */
    public void setSeries(gov.va.med.imaging.federation.webservices.types.FederationSeriesType[] series) {
        this.series = series;
    }

    public gov.va.med.imaging.federation.webservices.types.FederationSeriesType getSeries(int i) {
        return this.series[i];
    }

    public void setSeries(int i, gov.va.med.imaging.federation.webservices.types.FederationSeriesType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.webservices.federation.imaging.med.va.gov", ">FederationStudyType>component-series"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("series");
        elemField.setXmlName(new javax.xml.namespace.QName("", "series"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:types.webservices.federation.imaging.med.va.gov", "FederationSeriesType"));
