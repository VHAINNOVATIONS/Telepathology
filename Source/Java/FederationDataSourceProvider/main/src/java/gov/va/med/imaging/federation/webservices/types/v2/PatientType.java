...
public class PatientType  implements java.io.Serializable {
    ...
    private gov.va.med.imaging.federation.webservices.types.v2.FederationPatientSexType patientSex;
    ...
    public PatientType(
           ...
           gov.va.med.imaging.federation.webservices.types.v2.FederationPatientSexType patientSex) {
     ...
     * @return patientSex
     */
    public gov.va.med.imaging.federation.webservices.types.v2.FederationPatientSexType getPatientSex() {
        return patientSex;
    }
     ...
     * @param patientSex
     */
    public void setPatientSex(gov.va.med.imaging.federation.webservices.types.v2.FederationPatientSexType patientSex) {
        this.patientSex = patientSex;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:v2.types.webservices.federation.imaging.med.va.gov", "PatientType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:v2.types.webservices.federation.imaging.med.va.gov", "FederationPatientSexType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
