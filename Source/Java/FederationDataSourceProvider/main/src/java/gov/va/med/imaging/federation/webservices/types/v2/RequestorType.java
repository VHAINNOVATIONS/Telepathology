...
public class RequestorType  implements java.io.Serializable {
    ...
    private gov.va.med.imaging.federation.webservices.types.v2.RequestorTypePurposeOfUse purposeOfUse;
    ...
    public RequestorType(
           ...
           gov.va.med.imaging.federation.webservices.types.v2.RequestorTypePurposeOfUse purposeOfUse) {
     ...
     * @return purposeOfUse
     */
    public gov.va.med.imaging.federation.webservices.types.v2.RequestorTypePurposeOfUse getPurposeOfUse() {
        return purposeOfUse;
    }
     ...
     * @param purposeOfUse
     */
    public void setPurposeOfUse(gov.va.med.imaging.federation.webservices.types.v2.RequestorTypePurposeOfUse purposeOfUse) {
        this.purposeOfUse = purposeOfUse;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:v2.types.webservices.federation.imaging.med.va.gov", "RequestorType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:v2.types.webservices.federation.imaging.med.va.gov", ">RequestorType>purpose-of-use"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
