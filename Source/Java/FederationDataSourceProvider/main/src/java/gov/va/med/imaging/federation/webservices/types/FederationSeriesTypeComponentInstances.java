...
public class FederationSeriesTypeComponentInstances  implements java.io.Serializable {
    private gov.va.med.imaging.federation.webservices.types.FederationInstanceType[] instance;

    public FederationSeriesTypeComponentInstances() {
    }

    public FederationSeriesTypeComponentInstances(
           gov.va.med.imaging.federation.webservices.types.FederationInstanceType[] instance) {
     ...
     * @return instance
     */
    public gov.va.med.imaging.federation.webservices.types.FederationInstanceType[] getInstance() {
        return instance;
    }
     ...
     * @param instance
     */
    public void setInstance(gov.va.med.imaging.federation.webservices.types.FederationInstanceType[] instance) {
        this.instance = instance;
    }

    public gov.va.med.imaging.federation.webservices.types.FederationInstanceType getInstance(int i) {
        return this.instance[i];
    }

    public void setInstance(int i, gov.va.med.imaging.federation.webservices.types.FederationInstanceType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.webservices.federation.imaging.med.va.gov", ">FederationSeriesType>component-instances"));
