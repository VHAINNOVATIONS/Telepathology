 ...
 *
 */
public class FederationRestPostClient 
extends AbstractFederationRestClient 
{

	public FederationRestPostClient(String url, MediaType mediaType, 
			FederationConfiguration federationConfiguration)
	{
		super(url, mediaType, federationConfiguration);
	}
	
	public FederationRestPostClient(String url, String mediaType, 
			FederationConfiguration federationConfiguration)
	{
		super(url, mediaType, federationConfiguration);
	}
