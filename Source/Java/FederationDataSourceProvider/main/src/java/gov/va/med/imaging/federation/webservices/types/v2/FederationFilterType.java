...
public class FederationFilterType  implements java.io.Serializable {
    ...
    private gov.va.med.imaging.federation.webservices.types.v2.FederationFilterTypeOrigin origin;
    ...
    public FederationFilterType(
           ...
           gov.va.med.imaging.federation.webservices.types.v2.FederationFilterTypeOrigin origin,
     ...
     * @return origin
     */
    public gov.va.med.imaging.federation.webservices.types.v2.FederationFilterTypeOrigin getOrigin() {
        return origin;
    }
     ...
     * @param origin
     */
    public void setOrigin(gov.va.med.imaging.federation.webservices.types.v2.FederationFilterTypeOrigin origin) {
        this.origin = origin;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:v2.types.webservices.federation.imaging.med.va.gov", "FederationFilterType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:v2.types.webservices.federation.imaging.med.va.gov", ">FederationFilterType>origin"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
