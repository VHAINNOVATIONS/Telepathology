...
public class FederationStudyType  implements java.io.Serializable {
    ...
    private gov.va.med.imaging.federation.webservices.types.v2.FederationInstanceType firstImage;

    private java.lang.String rpcResponseMsg;

    private gov.va.med.imaging.federation.webservices.types.v2.FederationStudyTypeComponentSeries componentSeries;

    private gov.va.med.imaging.federation.webservices.types.v2.FederationStudyTypeStudyModalities studyModalities;
    ...
    public FederationStudyType(
           ...
           gov.va.med.imaging.federation.webservices.types.v2.FederationStudyTypeComponentSeries componentSeries,
           gov.va.med.imaging.federation.webservices.types.v2.FederationStudyTypeStudyModalities studyModalities,
     ...
     * @return firstImage
     */
    public gov.va.med.imaging.federation.webservices.types.v2.FederationInstanceType getFirstImage() {
        return firstImage;
    }
     ...
     * @param firstImage
     */
    public void setFirstImage(gov.va.med.imaging.federation.webservices.types.v2.FederationInstanceType firstImage) {
        this.firstImage = firstImage;
    }
     ...
     */
    public gov.va.med.imaging.federation.webservices.types.v2.FederationStudyTypeComponentSeries getComponentSeries() {
        return componentSeries;
    }
     ...
     */
    public void setComponentSeries(gov.va.med.imaging.federation.webservices.types.v2.FederationStudyTypeComponentSeries componentSeries) {
        this.componentSeries = componentSeries;
    }
     ...
     */
    public gov.va.med.imaging.federation.webservices.types.v2.FederationStudyTypeStudyModalities getStudyModalities() {
        return studyModalities;
    }
     ...
     */
    public void setStudyModalities(gov.va.med.imaging.federation.webservices.types.v2.FederationStudyTypeStudyModalities studyModalities) {
        this.studyModalities = studyModalities;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:v2.types.webservices.federation.imaging.med.va.gov", "FederationStudyType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:v2.types.webservices.federation.imaging.med.va.gov", ">FederationStudyType>component-series"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("studyModalities");
        elemField.setXmlName(new javax.xml.namespace.QName("", "study-modalities"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:v2.types.webservices.federation.imaging.med.va.gov", ">FederationStudyType>study-modalities"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
