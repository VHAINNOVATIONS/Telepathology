 ...
 * @version 1.0
 *
 * This is a MOCK implementation of a facade router.  This
 * should never be deployed in a production VIX.
 * This class returns either randomly generated data, default data or throws
 ...
 * Changes may be made to the template that generated this code (MockFacadeRouterImpl.ftl in
 * the CoreRouterAnnotationProcessor project), such changes will be reflected in
 * all mock facade router implementations.
 * 
 * NOTE: this is not production code and should never be deployed on a production
 * VIX.  This is a MOCK facade router implementation and returns randomly generated
 * data.
 * 
 ...
 */
 ...
 extends <#if extendsClassName??> ${extendsClassName} <#else>gov.va.med.imaging.core.interfaces.AbstractMockFacadeRouterImpl </#if>
