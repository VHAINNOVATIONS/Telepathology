 ...
 *
 */
public class DeletePathologyCaseTissueCommandImpl
extends AbstractDeletePathologyCaseSnomedCodeCommandImpl
{
	private static final long serialVersionUID = -2112545607425516984L;

	/**
	 * @param pathologyCaseUrn
	 * @param tissueId
	 */
	public DeletePathologyCaseTissueCommandImpl(
			PathologyCaseURN pathologyCaseUrn, String tissueId)
	{
		super(pathologyCaseUrn, tissueId);
	}
