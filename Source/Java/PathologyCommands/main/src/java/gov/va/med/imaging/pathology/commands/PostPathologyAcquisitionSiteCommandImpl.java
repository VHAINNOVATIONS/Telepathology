 ...
 *
 */
public class PostPathologyAcquisitionSiteCommandImpl
extends AbstractPathologyDataSourceCommandImpl<java.lang.Void>
{
	private static final long serialVersionUID = -3501773801417415420L;
	
	private final RoutingToken routingToken;
	private final PathologyAcquisitionSite acquisitionSite;
	private final boolean delete;
	
	public PostPathologyAcquisitionSiteCommandImpl(RoutingToken routingToken,
	...
	public PathologyAcquisitionSite getAcquisitionSite()
	{
	...
	{
		return new Class<?> [] {RoutingToken.class, PathologyAcquisitionSite.class, boolean.class};
	}
	...
	{
		return new Object [] {getRoutingToken(), getAcquisitionSite(), isDelete()};
	}
	...
	{
		spi.updateAcquisitionSite(getRoutingToken(), getAcquisitionSite(), isDelete());
