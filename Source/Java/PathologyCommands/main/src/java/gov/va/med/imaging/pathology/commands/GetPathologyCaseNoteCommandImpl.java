...
/**
 * Retrieve the note for a case
 * 
 * @author VHAISWWERFEJ
 *
 */
public class GetPathologyCaseNoteCommandImpl
extends AbstractPathologyDataSourceCommandImpl<String>
{
	private static final long serialVersionUID = -4281016041854536850L;
	
	private final PathologyCaseURN pathologyCaseUrn;
	
	public GetPathologyCaseNoteCommandImpl(PathologyCaseURN pathologyCaseUrn)
	{
		super();
	...
	{
		return spi.getCaseNote(getPathologyCaseUrn());
	}
