...
/**
 * Save case report fields
 * 
 * @author VHAISWWERFEJ
 *
 */
public class PostPathologyCaseReportFieldsCommandImpl
extends AbstractPathologyDataSourceCommandImpl<PathologySaveCaseReportResult>
{
	private static final long serialVersionUID = -2855899861918460917L;
	
	private final PathologyCaseURN pathologyCaseUrn;
	private final List<PathologyCaseReportField> fields;

	public PostPathologyCaseReportFieldsCommandImpl(
	...
	public List<PathologyCaseReportField> getFields()
	{
		return fields;
	}
	 ...
	 */
	@Override
	protected PathologySaveCaseReportResult getCommandResult(PathologyDataSourceSpi spi)
	throws ConnectionException, MethodException
	{
		return spi.saveCaseReportFields(getPathologyCaseUrn(), getFields());
	}
