 ...
 *
 */
public class GetPathologyPreferencesCommandImpl
extends AbstractPathologyDataSourceCommandImpl<String>
{
	private static final long serialVersionUID = -4304135468388890443L;
	
	private final RoutingToken routingToken;
	private final String userId;
	private final String label;

	public GetPathologyPreferencesCommandImpl(RoutingToken routingToken,
	...
	{
		return new Object[] {getRoutingToken(), getUserId(), getLabel()};
	}
	...
	{
		return spi.getPreferences(getRoutingToken(), getUserId(), getLabel());
	}
