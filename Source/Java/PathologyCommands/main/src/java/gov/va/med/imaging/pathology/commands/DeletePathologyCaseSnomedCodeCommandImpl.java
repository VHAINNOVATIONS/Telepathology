 ...
 *
 */
public class DeletePathologyCaseSnomedCodeCommandImpl
extends AbstractDeletePathologyCaseSnomedCodeCommandImpl
{
	private static final long serialVersionUID = 5635776154143084963L;
	 ...
	 * @param snomedField
	 */
	public DeletePathologyCaseSnomedCodeCommandImpl(
			PathologyCaseURN pathologyCaseUrn, String tissueId,
			String snomedId, PathologyField snomedField)
	{
		super(pathologyCaseUrn, tissueId, snomedId, snomedField);
	}
