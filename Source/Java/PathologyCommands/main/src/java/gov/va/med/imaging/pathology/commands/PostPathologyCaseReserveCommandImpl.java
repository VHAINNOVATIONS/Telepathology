...
/**
 * Lock or unlock a case reservation
 * 
 * @author VHAISWWERFEJ
 *
 */
public class PostPathologyCaseReserveCommandImpl
extends AbstractPathologyDataSourceCommandImpl<PathologyCaseReserveResult>
{
	...
	public PostPathologyCaseReserveCommandImpl(PathologyCaseURN pathologyCaseUrn, boolean lock)
	{
	 ...
	 */
	@Override
	protected PathologyCaseReserveResult getCommandResult(
			PathologyDataSourceSpi spi) 
	throws ConnectionException, MethodException
	{
		return spi.reserveCase(getPathologyCaseUrn(), isLock());
	}
