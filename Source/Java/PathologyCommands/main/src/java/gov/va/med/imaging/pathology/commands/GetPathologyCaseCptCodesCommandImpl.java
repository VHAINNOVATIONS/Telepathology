 ...
 *
 */
public class GetPathologyCaseCptCodesCommandImpl
extends AbstractPathologyDataSourceCommandImpl<List<PathologyCptCode>>
{
	private static final long serialVersionUID = -3604153937621239107L;
	
	private final PathologyCaseURN pathologyCaseUrn;
	
	public GetPathologyCaseCptCodesCommandImpl(PathologyCaseURN pathologyCaseUrn)
	{
		super();
	 ...
	 */
	@Override
	protected List<PathologyCptCode> getCommandResult(PathologyDataSourceSpi spi)
	throws ConnectionException, MethodException
	{
		return spi.getCaseCptCodes(getPathologyCaseUrn());
	}

	@Override
	protected List<PathologyCptCode> postProcessResult(
			List<PathologyCptCode> result)
	{
