 ...
 *
 */
public class GetPathologyCaseSnomedCodesCommandImpl
extends AbstractPathologyDataSourceCommandImpl<List<PathologySnomedCode>>
{
	private static final long serialVersionUID = -1366974502517278658L;
	
	private final PathologyCaseURN pathologyCaseUrn;
	
	public GetPathologyCaseSnomedCodesCommandImpl(PathologyCaseURN pathologyCaseUrn)
	{
		super();
	 ...
	 */
	@Override
	protected List<PathologySnomedCode> getCommandResult(
			PathologyDataSourceSpi spi) 
	throws ConnectionException, MethodException
	{
		return spi.getCaseSnomedCodes(getPathologyCaseUrn());
	}

	@Override
	protected List<PathologySnomedCode> postProcessResult(
			List<PathologySnomedCode> result)
	{
