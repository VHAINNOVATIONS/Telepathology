 ...
 *
 */
public class GetPathologySitesCommandImpl
extends AbstractPathologyDataSourceCommandImpl<List<PathologySite>>
{
	...
	public GetPathologySitesCommandImpl(RoutingToken routingToken)
	{
		super();
	 ...
	 */
	@Override
	protected List<PathologySite> getCommandResult(
			PathologyDataSourceSpi spi) 
	throws ConnectionException, MethodException
	{
		return spi.getSites(getRoutingToken());
	}

	@Override
	protected List<PathologySite> postProcessResult(
			List<PathologySite> result)
	{
