 ...
 */
@XmlRootElement
public class PathologyFederationCaseTemplateFieldType
{
	...
	public PathologyFederationCaseTemplateFieldType()
	{
		super();
	}

	public PathologyFederationCaseTemplateFieldType(String fieldNumber, String label,
			RestStringArrayType values)
	{
		super();
