 ...
 */
@XmlRootElement
public class PathologyFederationCaseSpecimenType
{
	...
	public PathologyFederationCaseSpecimenType()
	{
		super();
	}

	public PathologyFederationCaseSpecimenType(String specimen,
			String smearPrep, String stain, int numSlides, Date lastStainDate)
	{
		super();
