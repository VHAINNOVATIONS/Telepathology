...
public class InboundSOPClassStatistics implements InboundSOPClassStatisticsMBean {
	
	private String modalityCode;
	private int totalDicomObjectsProcessed;
	private int totalDicomObjectsRejected;
	
	public InboundSOPClassStatistics(String modalityCode){
	...
	/* (non-Javadoc)
	 * @see gov.va.med.imaging.dicom.common.stats.InboundSOPClassStatisticsMBean#getModalityCode()
	 */
	...
	/* (non-Javadoc)
	 * @see gov.va.med.imaging.dicom.common.stats.InboundSOPClassStatisticsMBean#getTotalDicomObjectsProcessed()
	 */
	...
	/* (non-Javadoc)
	 * @see gov.va.med.imaging.dicom.common.stats.InboundSOPClassStatisticsMBean#getTotalDicomObjectsRejected()
	 */
