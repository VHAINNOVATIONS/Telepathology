...
import gov.va.med.imaging.exchange.business.WorkList;
...
public class WorkListDAO extends BaseWorkListDAO<WorkList>
{
	private static String CREATE_WORK_LIST = "MAGV CREATE WORKLIST";
	//
	// Constructor
	//
	public WorkListDAO(){}
	public WorkListDAO(VistaSessionFactory sessionFactory)
	{
	...
	//
	@Override
	public VistaQuery generateCreateQuery(WorkList workList) 
	{
		VistaQuery vm = new VistaQuery(CREATE_WORK_LIST);
		vm.addParameter(VistaQuery.LITERAL, workList.getDescription());
