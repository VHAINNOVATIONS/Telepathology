 ...
 *
 */
public class VistaImagingExternalPackageDataSourceServiceV2
extends VistaImagingExternalPackageDataSourceService
{
	 ...
	 * @param protocol
	 */
	public VistaImagingExternalPackageDataSourceServiceV2(ResolvedArtifactSource resolvedArtifactSource, String protocol)
	{
	...
	{
		// if patch 104 is used then we can support deleted images for this study
		return true;
	}
