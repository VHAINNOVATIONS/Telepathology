...
public class DICOMGatewayConfigurationException extends MethodException
{
  public DICOMGatewayConfigurationException(){
      //constructor
  }
  public DICOMGatewayConfigurationException(String msg)
  {
    super(msg);
  }
  public DICOMGatewayConfigurationException(Exception e)
  {
    super(e);
  }
}