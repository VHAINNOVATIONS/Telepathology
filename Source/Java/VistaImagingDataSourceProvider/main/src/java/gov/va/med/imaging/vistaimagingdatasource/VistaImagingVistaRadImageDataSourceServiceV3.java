...
/**
 * This is simply an implementation that uses Patch 104 for version checking
 * 
 * @author VHAISWWERFEJ
 *
 */
public class VistaImagingVistaRadImageDataSourceServiceV3
extends VistaImagingVistaRadImageDataSourceServiceV2
{
	public final static String MAG_REQUIRED_VERSION = "3.0.104|VIX";
	
	public VistaImagingVistaRadImageDataSourceServiceV3(ResolvedArtifactSource resolvedArtifactSource, String protocol)
	{
