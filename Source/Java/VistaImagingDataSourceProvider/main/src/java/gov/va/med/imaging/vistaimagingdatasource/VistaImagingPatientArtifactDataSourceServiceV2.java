...
/**
 * Be careful about the naming here, version 1 of the VistaImagingPatientArtifactDataSource actually extends StudyGraphService (no version),
 * version 2 of VistaImagingPatientArtifactDataSource extends StudyGraphService version 1 (brilliant!)
 * 
 * @author vhaiswwerfej
 *
 */
public class VistaImagingPatientArtifactDataSourceServiceV2
extends VistaImagingStudyGraphDataSourceServiceV1
implements PatientArtifactDataSourceSpi
{
	
	public VistaImagingPatientArtifactDataSourceServiceV2(ResolvedArtifactSource resolvedArtifactSource, String protocol)
	{
