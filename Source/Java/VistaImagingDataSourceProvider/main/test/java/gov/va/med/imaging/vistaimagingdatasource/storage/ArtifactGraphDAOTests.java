...
public class ArtifactGraphDAOTests extends BaseArtifactDAOTests
{
	private ArtifactGraphDAO dao = new ArtifactGraphDAO();

	@Test
	public void translateGetEntityByExampleTest() throws RetrievalException
	{
		Artifact artifact = dao.translateGetEntityByExample(new Artifact(), getFullArtifactGraphXmlString());
	}
}