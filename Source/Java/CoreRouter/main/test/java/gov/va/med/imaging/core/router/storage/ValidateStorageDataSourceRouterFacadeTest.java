 ...
 *
 */
public class ValidateStorageDataSourceRouterFacadeTest
{
	@Test
	public void testGeneratedFacade()
	{
		try
		{
			GeneratedCodeValidationUtility.validateImplementation(
				gov.va.med.imaging.core.router.storage.StorageDataSourceRouter.class, 
				gov.va.med.imaging.core.router.storage.StorageDataSourceRouterImpl.class
			);
		}
