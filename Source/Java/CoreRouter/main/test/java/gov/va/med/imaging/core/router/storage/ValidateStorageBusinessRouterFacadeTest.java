 ...
 *
 */
public class ValidateStorageBusinessRouterFacadeTest
{
	@Test
	public void testGeneratedFacade()
	{
		try
		{
			GeneratedCodeValidationUtility.validateImplementation(
				gov.va.med.imaging.core.router.storage.StorageBusinessRouter.class, 
				gov.va.med.imaging.core.router.storage.StorageBusinessRouterImpl.class
			);
		}
