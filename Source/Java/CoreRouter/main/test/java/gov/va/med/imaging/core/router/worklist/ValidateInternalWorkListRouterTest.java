 ...
 *
 */
public class ValidateInternalWorkListRouterTest
{
	...
	public void testGeneratedFacade()
	{
		try
		{
			GeneratedCodeValidationUtility.validateImplementation(
				gov.va.med.imaging.core.router.worklist.InternalWorkListRouter.class, 
				gov.va.med.imaging.core.router.worklist.InternalWorkListRouterImpl.class
			);
		}
