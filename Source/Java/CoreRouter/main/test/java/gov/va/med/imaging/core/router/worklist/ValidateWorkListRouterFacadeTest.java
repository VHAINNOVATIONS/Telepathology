 ...
 *
 */
public class ValidateWorkListRouterFacadeTest
{
	@Test
	public void testGeneratedFacade()
	{
		try
		{
			GeneratedCodeValidationUtility.validateImplementation(
				gov.va.med.imaging.core.router.worklist.WorkListRouter.class, 
				gov.va.med.imaging.core.router.worklist.WorkListRouterImpl.class
			);
		}
