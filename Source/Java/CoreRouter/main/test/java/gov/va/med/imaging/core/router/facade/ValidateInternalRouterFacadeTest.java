 ...
 *
 */
public class ValidateInternalRouterFacadeTest
{
	@Test
	public void testGeneratedFacade()
	{
		try
		{
			GeneratedCodeValidationUtility.validateImplementation(
				gov.va.med.imaging.core.router.facade.InternalRouter.class, 
				gov.va.med.imaging.core.router.facade.InternalRouterImpl.class
			);
		}
