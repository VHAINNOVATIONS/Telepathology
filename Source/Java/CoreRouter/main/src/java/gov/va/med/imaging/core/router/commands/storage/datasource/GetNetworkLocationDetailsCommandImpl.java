...
public class GetNetworkLocationDetailsCommandImpl 
extends AbstractStorageDataSourceCommandImpl<NetworkLocationInfo>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "getNetworkLocationDetails";

	private final String networkLocationIEN;
	
	public GetNetworkLocationDetailsCommandImpl(String networkLocationIEN) 
	{
		super();
	...
	protected Object[] getSpiMethodParameters() {
		return new Object[]{networkLocationIEN} ;
	}
	...
	{
		return spi.getNetworkLocationDetails(networkLocationIEN);
	}
