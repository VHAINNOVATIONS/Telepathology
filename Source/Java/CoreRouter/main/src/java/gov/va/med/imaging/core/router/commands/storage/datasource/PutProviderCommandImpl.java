...
public class PutProviderCommandImpl 
extends AbstractStorageDataSourceCommandImpl<Provider>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "updateProvider";

	private final Provider provider;
	
	public PutProviderCommandImpl(Provider provider) 
	{
		super();
	...
	{
		return spi.updateProvider(provider);
	}
