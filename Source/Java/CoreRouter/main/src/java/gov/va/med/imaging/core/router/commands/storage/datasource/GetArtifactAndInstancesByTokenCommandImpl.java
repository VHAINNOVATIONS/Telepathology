...
public class GetArtifactAndInstancesByTokenCommandImpl 
extends AbstractStorageDataSourceCommandImpl<Artifact>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "getArtifactAndInstancesByToken";
	private final String artifactToken;

	public GetArtifactAndInstancesByTokenCommandImpl(String artifactToken) 
	{
		super();
	...
	protected Object[] getSpiMethodParameters() {
		return new Object[]{artifactToken} ;
	}
	...
	{
		return spi.getArtifactAndInstancesByToken(artifactToken);
	}
