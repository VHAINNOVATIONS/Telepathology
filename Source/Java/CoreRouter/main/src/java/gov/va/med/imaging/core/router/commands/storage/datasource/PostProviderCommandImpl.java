...
public class PostProviderCommandImpl 
extends AbstractStorageDataSourceCommandImpl<Provider>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "createProvider";

	private final Provider provider;
	
	public PostProviderCommandImpl(Provider provider) 
	{
		super();
	 ...
	 */
	@Override
	protected Provider getCommandResult(StorageDataSourceSpi spi)
	throws ConnectionException, MethodException 
	{
		return spi.createProvider(provider);
	}
