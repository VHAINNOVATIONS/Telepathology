...
public class PutArtifactCommandImpl 
extends AbstractStorageDataSourceCommandImpl<Artifact>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "updateArtifact";

	private final Artifact artifact;
	
	public PutArtifactCommandImpl(Artifact artifact) 
	{
		super();
	...
	{
		return spi.updateArtifact(artifact);
	}
