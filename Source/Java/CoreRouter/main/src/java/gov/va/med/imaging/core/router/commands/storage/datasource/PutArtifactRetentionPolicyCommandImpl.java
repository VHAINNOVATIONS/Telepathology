...
public class PutArtifactRetentionPolicyCommandImpl 
extends AbstractStorageDataSourceCommandImpl<ArtifactRetentionPolicy>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "updateArtifactRetentionPolicy";

	private final ArtifactRetentionPolicy artifactRetentionPolicy;
	
	public PutArtifactRetentionPolicyCommandImpl(ArtifactRetentionPolicy artifactRetentionPolicy) 
	{
		super();
	...
	{
		return spi.updateArtifactRetentionPolicy(artifactRetentionPolicy);
	}
