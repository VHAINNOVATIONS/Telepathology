...
public class GetArtifactAsGraphByIdCommandImpl 
extends AbstractStorageDataSourceCommandImpl<Artifact>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "getFullArtifactGraphById";
	private final String artifactId;

	public GetArtifactAsGraphByIdCommandImpl(String artifactId) 
	{
		super();
	...
	{
		return spi.getFullArtifactGraphById(artifactId);
	}
