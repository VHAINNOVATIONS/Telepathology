...
public class GetCurrentJukeboxWriteLocationCommandImpl 
extends AbstractStorageDataSourceCommandImpl<NetworkLocationInfo>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "getCurrentJukeboxWriteLocation";

	private final Provider provider;
	
	public GetCurrentJukeboxWriteLocationCommandImpl(Provider provider) 
	{
		super();
	...
	{
		return spi.getCurrentJukeboxWriteLocation(provider);
	}
