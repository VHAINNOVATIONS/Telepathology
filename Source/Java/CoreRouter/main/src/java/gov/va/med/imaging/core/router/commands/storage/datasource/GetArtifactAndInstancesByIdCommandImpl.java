...
public class GetArtifactAndInstancesByIdCommandImpl 
extends AbstractStorageDataSourceCommandImpl<Artifact>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "getArtifactAndInstancesById";
	private final Integer artifactId;

	public GetArtifactAndInstancesByIdCommandImpl(Integer artifactId) 
	{
		super();
	...
	{
		return spi.getArtifactAndInstancesById(artifactId);
	}
