...
public class GetImagingLocationListCommandImpl 
extends AbstractDicomImporterDataSourceCommandImpl<List<ImagingLocation>>
{
	private final String siteId;
	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "getImagingLocationList";

	public GetImagingLocationListCommandImpl(String siteId)
	{
		this.siteId = siteId;
	}
