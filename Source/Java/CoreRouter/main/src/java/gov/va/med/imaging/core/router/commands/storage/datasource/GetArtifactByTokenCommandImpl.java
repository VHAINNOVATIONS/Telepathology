...
public class GetArtifactByTokenCommandImpl 
extends AbstractStorageDataSourceCommandImpl<Artifact>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "getArtifactByToken";
	private final String artifactToken;

	public GetArtifactByTokenCommandImpl(String artifactToken) 
	{
		super();
	...
	{
		return spi.getArtifactByToken(artifactToken);
	}
