...
public class GetArtifactAsGraphByTokenCommandImpl 
extends AbstractStorageDataSourceCommandImpl<Artifact>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "getFullArtifactGraphByToken";
	private final String artifactToken;

	public GetArtifactAsGraphByTokenCommandImpl(String artifactToken) 
	{
		super();
	...
	{
		return spi.getFullArtifactGraphByToken(artifactToken);
	}
