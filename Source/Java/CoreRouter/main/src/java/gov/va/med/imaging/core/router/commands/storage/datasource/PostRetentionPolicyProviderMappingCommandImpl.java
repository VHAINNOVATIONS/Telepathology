...
public class PostRetentionPolicyProviderMappingCommandImpl 
extends AbstractStorageDataSourceCommandImpl<RetentionPolicyProviderMapping>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "createRetentionPolicyProviderMapping";

	private final RetentionPolicyProviderMapping mapping;
	
	public PostRetentionPolicyProviderMappingCommandImpl(RetentionPolicyProviderMapping mapping) 
	{
		super();
	...
	{
		return spi.createRetentionPolicyProviderMapping(mapping);
	}
