...
public class PostArtifactCommandImpl 
extends AbstractStorageDataSourceCommandImpl<Artifact>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "createArtifact";

	private final Artifact artifact;
	
	public PostArtifactCommandImpl(Artifact artifact) 
	{
		super();
	...
	{
		return spi.createArtifact(artifact);
	}
