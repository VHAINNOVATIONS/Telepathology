...
public class DeleteRetentionPolicyProviderMappingCommandImpl 
extends AbstractStorageDataSourceCommandImpl<Boolean>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "deleteRetentionPolicyProviderMapping";

	private final Integer mappingId;
	
	public DeleteRetentionPolicyProviderMappingCommandImpl(Integer mappingId) 
	{
		super();
	 ...
	 */
	@Override
	protected Boolean getCommandResult(StorageDataSourceSpi spi)
	throws ConnectionException, MethodException 
	{
		spi.deleteRetentionPolicyProviderMapping(mappingId);
		return true;
	}
