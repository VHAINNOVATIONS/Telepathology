...
public class FederationSeriesType  implements java.io.Serializable {
    ...
    private gov.va.med.imaging.federation.webservices.types.v3.FederationSeriesTypeComponentInstances componentInstances;
    ...
    public FederationSeriesType(
           ...
           int imageCount,
           gov.va.med.imaging.federation.webservices.types.v3.FederationSeriesTypeComponentInstances componentInstances,
     ...
     */
    public gov.va.med.imaging.federation.webservices.types.v3.FederationSeriesTypeComponentInstances getComponentInstances() {
        return componentInstances;
    }
     ...
     */
    public void setComponentInstances(gov.va.med.imaging.federation.webservices.types.v3.FederationSeriesTypeComponentInstances componentInstances) {
        this.componentInstances = componentInstances;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:v3.types.webservices.federation.imaging.med.va.gov", "FederationSeriesType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:v3.types.webservices.federation.imaging.med.va.gov", ">FederationSeriesType>component-instances"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
