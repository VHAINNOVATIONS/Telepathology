 ...
 */
@XmlRootElement
public class FederationExamResultType
{
	private FederationExamType [] exams;
	private FederationArtifactResultStatusType artifactResultStatus;
	private FederationArtifactResultErrorType [] errors;
	
	public FederationExamResultType()
	{
		super();
	}

	public FederationExamType[] getExams()
	{
		return exams;
	}

	public void setExams(FederationExamType[] exams)
	{
		this.exams = exams;
	}
