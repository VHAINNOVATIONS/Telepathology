 ...
 * 
 * @author vhaiswwerfej
 * @deprecated Should use RestStringArrayType instead but this must remain for backwards compatibility
 *
 */
@XmlRootElement
public class FederationStringArrayType
{
	private String [] values;
	
	public FederationStringArrayType()
	{
		super();
	}
