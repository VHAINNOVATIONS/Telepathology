...
public class PatientSensitiveCheckResponseType  implements java.io.Serializable {
    private gov.va.med.imaging.federation.webservices.types.v3.PatientSensitivityLevelType patientSensitivityLevel;
    ...
    public PatientSensitiveCheckResponseType(
           gov.va.med.imaging.federation.webservices.types.v3.PatientSensitivityLevelType patientSensitivityLevel,
     ...
     */
    public gov.va.med.imaging.federation.webservices.types.v3.PatientSensitivityLevelType getPatientSensitivityLevel() {
        return patientSensitivityLevel;
    }
     ...
     */
    public void setPatientSensitivityLevel(gov.va.med.imaging.federation.webservices.types.v3.PatientSensitivityLevelType patientSensitivityLevel) {
        this.patientSensitivityLevel = patientSensitivityLevel;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:v3.types.webservices.federation.imaging.med.va.gov", "PatientSensitiveCheckResponseType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:v3.types.webservices.federation.imaging.med.va.gov", "PatientSensitivityLevelType"));
