 ...
 */
@XmlRootElement
public class FederationCprsIdentifierType
{
	private String cprsIdentifier;
	
	public FederationCprsIdentifierType()
	{
		super();
	}
	...
	public void setCprsIdentifier(String cprsIdentifier)
	{
