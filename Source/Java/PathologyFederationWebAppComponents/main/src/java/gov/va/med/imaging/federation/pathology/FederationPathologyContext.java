 ...
 *
 */
public class FederationPathologyContext 
{

	private static Logger logger = Logger.getLogger(FederationPathologyContext.class);
	
	public static FederationPathologyRouter getFederationRouter()
	{
		FederationPathologyRouter router = null;
		TransactionContext transactionContext = TransactionContextFactory.get();
		try
		{
			router = FacadeRouterUtility.getFacadeRouter(FederationPathologyRouter.class);
		} 
		catch (Exception x)
		{
