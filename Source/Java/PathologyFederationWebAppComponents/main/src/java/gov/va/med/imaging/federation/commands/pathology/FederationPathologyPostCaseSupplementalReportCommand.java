 ...
 *
 */
public class FederationPathologyPostCaseSupplementalReportCommand
extends AbstractFederationPathologyCommand<Boolean, RestBooleanReturnType>
{
	private final String caseId;
	private final boolean verified;
	private final PathologyFederationCaseSaveSupplementalReportType report;
	private final String interfaceVersion;
	
	public FederationPathologyPostCaseSupplementalReportCommand(String caseId, 
			boolean verified, PathologyFederationCaseSaveSupplementalReportType report,
			String interfaceVersion)
	{
		super("savePathologyCaseSupplementalReport");
		this.caseId = caseId;
		this.report = report;
	...
	public PathologyFederationCaseSaveSupplementalReportType getReport()
	{
		return report;
	}
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			getRouter().savePathologyCaseSupplementalReport(pathologyCaseUrn, 
					getReport().getReportContents(), getReport().getDate(), isVerified());
			return true;
		}
