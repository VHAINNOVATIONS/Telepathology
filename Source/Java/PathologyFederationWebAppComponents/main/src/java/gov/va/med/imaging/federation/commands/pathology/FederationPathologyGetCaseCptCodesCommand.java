 ...
 *
 */
public class FederationPathologyGetCaseCptCodesCommand
extends AbstractFederationPathologyCommand<List<PathologyCptCode>, PathologyFederationCptCodeType[]>
{
	 ...
	 * @param methodName
	 */
	public FederationPathologyGetCaseCptCodesCommand(String caseId,
			String interfaceVersion)
	{
		super("getPathologyCaseCptCodes");
		this.caseId = caseId;
	 ...
	 */
	@Override
	protected PathologyFederationCptCodeType[] translateRouterResult(
			List<PathologyCptCode> routerResult) 
	throws TranslationException, MethodException
	{
		return PathologyFederationRestTranslator.translateCptCodes(routerResult);
	}
	 ...
	 */
	@Override
	protected Class<PathologyFederationCptCodeType[]> getResultClass()
	{
		return PathologyFederationCptCodeType[].class;
	}
	 ...
	 */
	@Override
	public Integer getEntriesReturned(PathologyFederationCptCodeType[] translatedResult)
	{
