 ...
 *
 */
public class FederationPathologyUpdateReadingSiteCommand
extends AbstractFederationPathologyCommand<Boolean, RestBooleanReturnType>
{
	private final String routingTokenString;
	private final PathologyFederationReadingSiteType readingSite;
	 ...
	 * @param methodName
	 */
	public FederationPathologyUpdateReadingSiteCommand(String routingTokenString,
			PathologyFederationReadingSiteType readingSite,
			boolean delete,
			String interfaceVersion)
	{
		super("updatePathologyReadingSite");
	...
	public PathologyFederationReadingSiteType getReadingSite()
	{
		return readingSite;
	}
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			PathologyReadingSite readingSite = PathologyFederationRestTranslator.translate(getReadingSite());
			getRouter().updateReadingSite(routingToken, readingSite, isDelete());
			return true;
		}
	...
	{
		return "to site '" + getRoutingTokenString() + "', updating reading site '" + getReadingSite().getSiteId() + ", deleting [" + isDelete() + "].";
	}
