 ...
 *
 */
public class FederationPathologyGetCaseSpecimensCommand
extends AbstractFederationPathologyCommand<List<PathologyCaseSpecimen>, PathologyFederationCaseSpecimenType[]>
{
	 ...
	 * @param methodName
	 */
	public FederationPathologyGetCaseSpecimensCommand(String caseId,
			String interfaceVersion)
	{
		super("getPathologyCaseSpecimens");
		this.caseId = caseId;
	 ...
	 */
	@Override
	protected PathologyFederationCaseSpecimenType[] translateRouterResult(
			List<PathologyCaseSpecimen> routerResult)
	throws TranslationException, MethodException
	{
		return PathologyFederationRestTranslator.translateCaseSpecimens(routerResult);
	}
	 ...
	 */
	@Override
	protected Class<PathologyFederationCaseSpecimenType[]> getResultClass()
	{
	...
	public Integer getEntriesReturned(
			PathologyFederationCaseSpecimenType[] translatedResult)
	{
