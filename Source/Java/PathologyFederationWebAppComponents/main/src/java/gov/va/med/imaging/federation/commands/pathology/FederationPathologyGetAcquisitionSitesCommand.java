 ...
 *
 */
public class FederationPathologyGetAcquisitionSitesCommand
extends AbstractFederationPathologyCommand<List<AbstractPathologySite>, PathologyFederationAcquisitionSiteType[]>
{
	 ...
	 * @param methodName
	 */
	public FederationPathologyGetAcquisitionSitesCommand(String routingTokenString, String interfaceVersion)
	{
		super("getPathologyAcqusitionSites");
	 ...
	 */
	@Override
	protected PathologyFederationAcquisitionSiteType[] translateRouterResult(
			List<AbstractPathologySite> routerResult)
	throws TranslationException, MethodException
	{
		return PathologyFederationRestTranslator.translateAbstractSitesToAcquisitionSites(routerResult);
	}
	 ...
	 */
	@Override
	protected Class<PathologyFederationAcquisitionSiteType[]> getResultClass()
	{
		return PathologyFederationAcquisitionSiteType[].class;
	}
	...
	public Integer getEntriesReturned(
			PathologyFederationAcquisitionSiteType[] translatedResult)
	{
