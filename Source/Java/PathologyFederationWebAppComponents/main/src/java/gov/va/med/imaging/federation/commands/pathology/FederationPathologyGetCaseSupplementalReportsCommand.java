 ...
 *
 */
public class FederationPathologyGetCaseSupplementalReportsCommand
extends AbstractFederationPathologyCommand<List<PathologyCaseSupplementalReport>, PathologyFederationCaseSupplementalReportType[]>
{
	 ...
	 * @param methodName
	 */
	public FederationPathologyGetCaseSupplementalReportsCommand(String caseId,
			String interfaceVersion)
	{
		super("getPathologyCaseSupplementalReports");
		this.caseId = caseId;
	 ...
	 */
	@Override
	protected PathologyFederationCaseSupplementalReportType[] translateRouterResult(
			List<PathologyCaseSupplementalReport> routerResult)
	throws TranslationException, MethodException
	{
		return PathologyFederationRestTranslator.translateSupplementalReports(routerResult);
	}
	 ...
	 */
	@Override
	protected Class<PathologyFederationCaseSupplementalReportType[]> getResultClass()
	{
		return PathologyFederationCaseSupplementalReportType[].class;
	}
	...
	public Integer getEntriesReturned(
			PathologyFederationCaseSupplementalReportType[] translatedResult)
	{
