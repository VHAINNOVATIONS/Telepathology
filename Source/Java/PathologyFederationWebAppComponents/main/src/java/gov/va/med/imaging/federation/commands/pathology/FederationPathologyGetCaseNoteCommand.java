 ...
 *
 */
public class FederationPathologyGetCaseNoteCommand
extends AbstractFederationPathologyCommand<String, RestStringType>
{
	 ...
	 * @param methodName
	 */
	public FederationPathologyGetCaseNoteCommand(String caseId, 
			String interfaceVersion)
	{
		super("getPathologyCaseNote");
		this.caseId = caseId;
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			return getRouter().getCaseNote(pathologyCaseUrn);
		}
