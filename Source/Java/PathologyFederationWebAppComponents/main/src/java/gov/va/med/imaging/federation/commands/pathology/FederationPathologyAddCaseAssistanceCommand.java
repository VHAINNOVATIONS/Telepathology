 ...
 *
 */
public class FederationPathologyAddCaseAssistanceCommand
extends AbstractFederationPathologyCommand<PathologyCaseUpdateAttributeResult, PathologyFederationCaseUpdateAttributeResultType>
{
	private final String caseId;
	private final PathologyFederationCaseAssistanceType assistanceType;
	 ...
	 * @param methodName
	 */
	public FederationPathologyAddCaseAssistanceCommand(String caseId, 
			PathologyFederationCaseAssistanceType assistanceType, String stationNumber, String interfaceVersion)
	{
		super("pathologyAddCaseAssistance");
		this.caseId = caseId;
	...
	public PathologyFederationCaseAssistanceType getAssistanceType()
	{
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			PathologyCaseAssistance caseAssistance = PathologyFederationRestTranslator.translate(getAssistanceType()); 
			return getRouter().addPathologyCaseAssistance(pathologyCaseUrn, caseAssistance, getStationNumber());
		}
	...
	{
		return "for case '" + getCaseId() + "', assistance type '" + getAssistanceType() + "', station number '" + getStationNumber() + "'.";
	}
	 ...
	 */
	@Override
	protected PathologyFederationCaseUpdateAttributeResultType translateRouterResult(
	 ...
	 */
	@Override
	protected Class<PathologyFederationCaseUpdateAttributeResultType> getResultClass()
	{
	...
	public Integer getEntriesReturned(
			PathologyFederationCaseUpdateAttributeResultType translatedResult)
	{
