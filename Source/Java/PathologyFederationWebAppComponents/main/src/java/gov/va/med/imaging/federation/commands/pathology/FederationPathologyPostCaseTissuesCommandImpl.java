 ...
 *
 */
public class FederationPathologyPostCaseTissuesCommandImpl
extends AbstractFederationPathologyCommand<String, RestStringType>
{
	 ...
	 * @param methodName
	 */
	public FederationPathologyPostCaseTissuesCommandImpl(String caseId, String tissueId, 
			String interfaceVersion)
	{
		super("savePathologyCaseTissues");
		this.caseId = caseId;
