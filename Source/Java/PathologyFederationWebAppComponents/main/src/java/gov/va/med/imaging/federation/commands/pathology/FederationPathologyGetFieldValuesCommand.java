 ...
 *
 */
public class FederationPathologyGetFieldValuesCommand
extends AbstractFederationPathologyCommand<List<PathologyFieldValue>, PathologyFederationFieldValueType[]>
{
	private final String routingTokenString;
	private final PathologyFederationFieldType pathologyField;
	 ...
	 * @param methodName
	 */
	public FederationPathologyGetFieldValuesCommand(String routingTokenString, PathologyFederationFieldType pathologyField, 
			String searchParameter, String interfaceVersion)
	{
		super("getPathologyFieldValue");
	...
	public PathologyFederationFieldType getPathologyField()
	{
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			PathologyField field = PathologyFederationRestTranslator.translate(getPathologyField());
	 ...
	 */
	@Override
	protected PathologyFederationFieldValueType[] translateRouterResult(
			List<PathologyFieldValue> routerResult)
	throws TranslationException, MethodException
	{
		return PathologyFederationRestTranslator.translateFieldValues(routerResult);
	}
	 ...
	 */
	@Override
	protected Class<PathologyFederationFieldValueType[]> getResultClass()
	{
		return PathologyFederationFieldValueType[].class;
	}
	 ...
	 */
	@Override
	public Integer getEntriesReturned(PathologyFederationFieldValueType[] translatedResult)
	{
