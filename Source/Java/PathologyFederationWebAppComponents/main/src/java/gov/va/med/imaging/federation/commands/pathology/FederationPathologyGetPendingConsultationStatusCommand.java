 ...
 *
 */
public class FederationPathologyGetPendingConsultationStatusCommand
extends AbstractFederationPathologyCommand<Boolean, RestBooleanReturnType>
{
	...
	public FederationPathologyGetPendingConsultationStatusCommand(String routingTokenString, 
			String stationNumber, String interfaceVersion)
	{
		super("checkPathologyPendingConsultationStatus");
