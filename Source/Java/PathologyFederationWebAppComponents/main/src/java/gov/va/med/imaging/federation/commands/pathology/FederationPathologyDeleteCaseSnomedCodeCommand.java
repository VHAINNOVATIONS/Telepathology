 ...
 *
 */
public class FederationPathologyDeleteCaseSnomedCodeCommand
extends AbstractFederationPathologyCommand<Boolean, RestBooleanReturnType>
{
	...
	private final PathologyFederationFieldType snomedField;
	 ...
	 * @param methodName
	 */
	public FederationPathologyDeleteCaseSnomedCodeCommand(String caseId, String tissueId,
			String snomedId, PathologyFederationFieldType snomedField, String etiologyId,
			String interfaceVersion)
	{
		super("deletePathologyCaseSnomedCode");
		this.caseId = caseId;
	...
	public PathologyFederationFieldType getSnomedField()
	{
		return snomedField;
	}
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			else if(getEtiologyId() == null)
			{
				...
				PathologyField field = PathologyFederationRestTranslator.translate(getSnomedField());
