 ...
 *
 */
public class FederationPathologyReserveCaseCommand
extends AbstractFederationPathologyCommand<PathologyCaseReserveResult, PathologyFederationCaseReserveResultType>
{
	...
	public FederationPathologyReserveCaseCommand(String pathologyCaseId, boolean lock,
			String interfaceVersion)
	{
		super("reservePathologyCase");
	 ...
	 */
	@Override
	protected PathologyFederationCaseReserveResultType translateRouterResult(
	 ...
	 */
	@Override
	protected Class<PathologyFederationCaseReserveResultType> getResultClass()
	{
		return PathologyFederationCaseReserveResultType.class;
	}
	...
	public Integer getEntriesReturned(
			PathologyFederationCaseReserveResultType translatedResult)
	{
		return null;
	}
}
