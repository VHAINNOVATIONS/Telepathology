 ...
 *
 */
public class FederationPathologyPostCaseNoteCommand
extends AbstractFederationPathologyCommand<Boolean, RestBooleanReturnType>
{
	private final String caseId;
	private final RestStringType note;
	private final String interfaceVersion;

	/**
	 * @param methodName
	 */
	public FederationPathologyPostCaseNoteCommand(String caseId, RestStringType note,
			String interfaceVersion)
	{
		super("savePathologyCaseNote");
		this.caseId = caseId;
		this.note = note;
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			getRouter().saveCaseNote(pathologyCaseUrn, getNote().getValue());
			return true;
		}
