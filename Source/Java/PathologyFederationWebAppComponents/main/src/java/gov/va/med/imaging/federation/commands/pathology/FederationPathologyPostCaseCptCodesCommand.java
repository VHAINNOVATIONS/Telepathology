 ...
 *
 */
public class FederationPathologyPostCaseCptCodesCommand
extends AbstractFederationPathologyCommand<List<PathologyCptCodeResult>, PathologyFederationCptCodeResultType[]>
{
	 ...
	 * @param methodName
	 */
	public FederationPathologyPostCaseCptCodesCommand(String caseId, String locationFieldId,
			RestStringArrayType cptCodes, String interfaceVersion)
	{
		super("savePathologyCaseCPTCodes");
		this.caseId = caseId;
	 ...
	 */
	@Override
	protected PathologyFederationCptCodeResultType[] translateRouterResult(List<PathologyCptCodeResult> routerResult)
			throws TranslationException, MethodException
	{
		return PathologyFederationRestTranslator.translateCptCodeResults(routerResult);
	}
	 ...
	 */
	@Override
	protected Class<PathologyFederationCptCodeResultType[]> getResultClass()
	{
		return PathologyFederationCptCodeResultType[].class;
	}
	 ...
	 */
	@Override
	public Integer getEntriesReturned(PathologyFederationCptCodeResultType[] translatedResult)
	{
