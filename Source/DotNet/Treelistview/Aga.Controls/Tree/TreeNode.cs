...
namespace Aga.Controls.Tree
{
	public sealed class TreeNode : INotifyPropertyChanged
	{
        ...
        public Collection<TreeNode> Children    // cpt 3/25/15: needed to be public to extract tree of active caselist
		{
			...
			switch (e.Action)
			{
				case NotifyCollectionChangedAction.Add:
					if (e.NewItems != null)
					{
                        ...
                        int rowIndex = Tree.Rows.ObservableRowItems.IndexOf(this);
